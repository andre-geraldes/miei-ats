...
convertATermToString(appl.getArgument(0), atConv)
  ...
  /**
    ...
    */
  public static tom.library.enumerator.F<tom.library.enumerator.Enumeration<String>,tom.library.enumerator.Enumeration<maqv.msp.types.Termo>> funMake() {
    return 
        new tom.library.enumerator.F<tom.library.enumerator.Enumeration<String>,tom.library.enumerator.Enumeration<maqv.msp.types.Termo>>() {
          public tom.library.enumerator.Enumeration<maqv.msp.types.Termo> apply(final tom.library.enumerator.Enumeration<String> t1) {
            return tom.library.enumerator.Enumeration.apply(tom.library.enumerator.Enumeration.singleton((tom.library.enumerator.F<String,maqv.msp.types.Termo>) 
        new tom.library.enumerator.F<String,maqv.msp.types.Termo>() {
          public maqv.msp.types.Termo apply(final String t1) {
            return make(t1);
          }
        }),t1).pay();
          }
