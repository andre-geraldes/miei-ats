...
public abstract class Termo extends maqv.msp.mspAbstractType  {
  ...
  protected static tom.library.enumerator.Enumeration<maqv.msp.types.Termo> enumTermo = null;
  public static final tom.library.enumerator.Enumeration<maqv.msp.types.Termo> tmpenumTermo = new tom.library.enumerator.Enumeration<maqv.msp.types.Termo>((tom.library.enumerator.LazyList<tom.library.enumerator.Finite<maqv.msp.types.Termo>>) null);

  public static tom.library.enumerator.Enumeration<maqv.msp.types.Termo> getEnumeration() {
    if(enumTermo == null) { 
      enumTermo = maqv.msp.types.termo.I.funMake().apply(tom.library.enumerator.Combinators.makeint())
        .plus(maqv.msp.types.termo.S.funMake().apply(tom.library.enumerator.Combinators.makeString()))
        .plus(maqv.msp.types.termo.B.funMake().apply(maqv.msp.types.Boool.tmpenumBoool))
        .plus(maqv.msp.types.termo.F.funMake().apply(tom.library.enumerator.Combinators.makeint()))
        .plus(maqv.msp.types.termo.Vazio.funMake().apply(maqv.msp.types.Termo.tmpenumTermo));

      maqv.msp.types.Boool.getEnumeration();

      tmpenumTermo.p1 = new tom.library.enumerator.P1<tom.library.enumerator.LazyList<tom.library.enumerator.Finite<maqv.msp.types.Termo>>>() {
        public tom.library.enumerator.LazyList<tom.library.enumerator.Finite<maqv.msp.types.Termo>> _1() { return enumTermo.parts(); }
      };
