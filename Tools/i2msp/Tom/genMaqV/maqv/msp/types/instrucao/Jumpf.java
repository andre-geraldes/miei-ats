...
convertATermToString(appl.getArgument(0), atConv)
  ...
  /**
    ...
    */
  public static tom.library.enumerator.F<tom.library.enumerator.Enumeration<String>,tom.library.enumerator.Enumeration<maqv.msp.types.Instrucao>> funMake() {
    return 
        new tom.library.enumerator.F<tom.library.enumerator.Enumeration<String>,tom.library.enumerator.Enumeration<maqv.msp.types.Instrucao>>() {
          public tom.library.enumerator.Enumeration<maqv.msp.types.Instrucao> apply(final tom.library.enumerator.Enumeration<String> t1) {
            return tom.library.enumerator.Enumeration.apply(tom.library.enumerator.Enumeration.singleton((tom.library.enumerator.F<String,maqv.msp.types.Instrucao>) 
        new tom.library.enumerator.F<String,maqv.msp.types.Instrucao>() {
          public maqv.msp.types.Instrucao apply(final String t1) {
            return make(t1);
          }
        }),t1).pay();
          }
