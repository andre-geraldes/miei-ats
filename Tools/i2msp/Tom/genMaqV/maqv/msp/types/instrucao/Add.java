...
public final class Add extends maqv.msp.types.Instrucao implements tom.library.sl.Visitable  {
 ...
 //shared.SharedObject
  ...
  /**
    ...
    */
  public static tom.library.enumerator.F<tom.library.enumerator.Enumeration<maqv.msp.types.Instrucao>, tom.library.enumerator.Enumeration<maqv.msp.types.Instrucao>> funMake() {
    return new tom.library.enumerator.F<tom.library.enumerator.Enumeration<maqv.msp.types.Instrucao>, tom.library.enumerator.Enumeration<maqv.msp.types.Instrucao>>() {
      public tom.library.enumerator.Enumeration<maqv.msp.types.Instrucao> apply(final tom.library.enumerator.Enumeration<maqv.msp.types.Instrucao> e) {
        return tom.library.enumerator.Enumeration.singleton((maqv.msp.types.Instrucao) make());
      }
    };
  }
