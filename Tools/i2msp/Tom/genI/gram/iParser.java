// $ANTLR 3.2 Sep 23, 2009 12:02:23 gram/i.g 2015-11-25 14:19:25
 package gram; 
...
public class iParser extends Parser {
    ...
    public final iParser.declaracao_return declaracao() throws RecognitionException {
        ...
        try {
            ...
            // AST REWRITE
            // elements: c4, dec_nodo, idTipo, c2, c3, c1
            // token labels: 
    ...
    public final iParser.funcao_return funcao() throws RecognitionException {
        ...
        try {
            ...
            // AST REWRITE
            // elements: blocoCodigo, argumentos, c4, c7, c6, c5, c2, ID, c3, idTipo, c1
            // token labels: 
        ...
        try {
            ...
            switch (alt10) {
                case 1 :
                    ...
                    // AST REWRITE
                    // elements: else_, c3, blocoCodigo, c2, c5, c1, c4, condicao
                    // token labels: 
                ...
                case 2 :
                    ...
                    // AST REWRITE
                    // elements: c4, c2, condicao, c3, c5, c1, blocoCodigo
                    // token labels: 
                    // rule labels: retval, c1, c2, c5, c4, c3
                    // token list labels: 
                    // rule list labels: 
    ...
    public final iParser.for__return for_() throws RecognitionException {
        ...
        try {
            ...
            // AST REWRITE
            // elements: blocoCodigo, c3, c5, c4, c8, c7, c2, for_declaracao, c1, c6, expressao, condicao
            // token labels: 
    ...
    public final iParser.while__return while_() throws RecognitionException {
        ...
        try {
            ...
            // AST REWRITE
            // elements: blocoCodigo, c3, c4, c5, c6, c1, c2, condicao
            // token labels: 
    ...
    public final iParser.call_return call() throws RecognitionException {
        ...
        try {
            ...
            // AST REWRITE
            // elements: c1, ID, c4, parametros, c3, c2, c5
            // token labels: 
            // rule labels: retval, c1, c2, c5, c4, c3
            // token list labels: 
            // rule list labels: 
    ...
    public final iParser.print__return print_() throws RecognitionException {
        ...
        try {
            ...
            // AST REWRITE
            // elements: c2, c1, c5, c4, c3, expressao
            // token labels: 
            // rule labels: retval, c1, c2, c5, c4, c3
            // token list labels: 
            // rule list labels: 
    ...
    public final iParser.input__return input_() throws RecognitionException {
        ...
        try {
            ...
            // AST REWRITE
            // elements: c2, c5, c1, idTipo, c3, c4
            // token labels: 
            // rule labels: retval, c1, c2, c5, c4, c3
            // token list labels: 
            // rule list labels: 
        ...
        try {
            ...
            switch (alt17) {
                case 1 :
                    ...
                    // AST REWRITE
                    // elements: condicao, c4, c2, c3, condicao_ou, expressao, c1
                    // token labels: 
                    // rule labels: retval, c1, c2, c4, c3
                    // token list labels: 
                    // rule list labels: 
            	...
            	case 1 :
            	    ...
            	    switch (alt20) {
            	        ...
            	        case 2 :
            	            ...
            	            // AST REWRITE
            	            // elements: c, condicao_comparacao, c2, c1
            	            // token labels: 
            	        ...
            	        case 3 :
            	            ...
            	            // AST REWRITE
            	            // elements: c2, c, c1, condicao_comparacao
            	            // token labels: 
            	            // rule labels: retval, c1, c, c2
            	            // token list labels: 
            	            // rule list labels: 
            	...
            	case 1 :
            	    ...
            	    switch (alt22) {
            	        case 1 :
            	            ...
            	            // AST REWRITE
            	            // elements: c2, e, condicao_igualdade, c1
            	            // token labels: 
            	        ...
            	        case 2 :
            	            ...
            	            // AST REWRITE
            	            // elements: condicao_igualdade, c2, c2, e
            	            // token labels: 
    ...
    public final iParser.atribuicao_return atribuicao() throws RecognitionException {
        ...
        try {
            ...
            // AST REWRITE
            // elements: c4, opAtribuicao, c2, c3, ID, c1, condicao
            // token labels: 
            // rule labels: retval, c1, c2, c4, c3
            // token list labels: 
            // rule list labels: 
