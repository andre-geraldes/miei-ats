...
public final class DFloat extends gram.i.types.DefTipo implements tom.library.sl.Visitable  {
 ...
 //shared.SharedObject
  ...
  /**
    ...
    */
  public static tom.library.enumerator.F<tom.library.enumerator.Enumeration<gram.i.types.DefTipo>, tom.library.enumerator.Enumeration<gram.i.types.DefTipo>> funMake() {
    return new tom.library.enumerator.F<tom.library.enumerator.Enumeration<gram.i.types.DefTipo>, tom.library.enumerator.Enumeration<gram.i.types.DefTipo>>() {
      public tom.library.enumerator.Enumeration<gram.i.types.DefTipo> apply(final tom.library.enumerator.Enumeration<gram.i.types.DefTipo> e) {
        return tom.library.enumerator.Enumeration.singleton((gram.i.types.DefTipo) make());
      }
    };
  }
