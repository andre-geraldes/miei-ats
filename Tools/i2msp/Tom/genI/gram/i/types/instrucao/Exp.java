...
gram.i.types.Expressao.fromTerm(appl.getArgument(0),atConv)
  ...
  /**
    ...
    */
  public static tom.library.enumerator.F<tom.library.enumerator.Enumeration<gram.i.types.Expressao>,tom.library.enumerator.Enumeration<gram.i.types.Instrucao>> funMake() {
    return 
        new tom.library.enumerator.F<tom.library.enumerator.Enumeration<gram.i.types.Expressao>,tom.library.enumerator.Enumeration<gram.i.types.Instrucao>>() {
          public tom.library.enumerator.Enumeration<gram.i.types.Instrucao> apply(final tom.library.enumerator.Enumeration<gram.i.types.Expressao> t1) {
            return tom.library.enumerator.Enumeration.apply(tom.library.enumerator.Enumeration.singleton((tom.library.enumerator.F<gram.i.types.Expressao,gram.i.types.Instrucao>) 
        new tom.library.enumerator.F<gram.i.types.Expressao,gram.i.types.Instrucao>() {
          public gram.i.types.Instrucao apply(final gram.i.types.Expressao t1) {
            return make(t1);
          }
        }),t1).pay();
          }
