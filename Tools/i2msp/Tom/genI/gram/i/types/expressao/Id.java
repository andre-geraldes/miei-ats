...
convertATermToString(appl.getArgument(0), atConv)
  ...
  /**
    ...
    */
  public static tom.library.enumerator.F<tom.library.enumerator.Enumeration<String>,tom.library.enumerator.Enumeration<gram.i.types.Expressao>> funMake() {
    return 
        new tom.library.enumerator.F<tom.library.enumerator.Enumeration<String>,tom.library.enumerator.Enumeration<gram.i.types.Expressao>>() {
          public tom.library.enumerator.Enumeration<gram.i.types.Expressao> apply(final tom.library.enumerator.Enumeration<String> t1) {
            return tom.library.enumerator.Enumeration.apply(tom.library.enumerator.Enumeration.singleton((tom.library.enumerator.F<String,gram.i.types.Expressao>) 
        new tom.library.enumerator.F<String,gram.i.types.Expressao>() {
          public gram.i.types.Expressao apply(final String t1) {
            return make(t1);
          }
        }),t1).pay();
          }
